...
public class ContactModificationTests extends TestBase {
    ...
    public void testModificationContact() {
        ...
        int i = before.size();
        ContactData contact = new ContactData(before.get(i - 1).getId(),"edit_first name 1", "edit_middle name 1", "edit_last name 1", "edit_nickname 1", "edit_title 1", "edit_company 1", "edit_address 1", "11111111", "2222222", "33333333", "44444444", "edit_email1@test.com", "edit_email2@test.com", "edit_email3@test.com", "edit_localhost.com", "1889", "2000", "edit_secondary address 1", "edit_test notes", null);
        app.getContactHelper().modifyContact(i, contact);
